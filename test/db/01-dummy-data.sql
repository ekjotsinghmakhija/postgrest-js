...
VALUES
    ('deezbot', 'ONLINE', '[1,2)'::int4range, 'fat cat'::tsvector),
...
VALUES
    ('Hello World 👋', 1, 'deezbot'),
    ('Perfection is attained, not when there is nothing more to add, but when there is nothing left to take away.', 2, 'deezbot');

INSERT INTO
    personal.users (username, status, age_range)
VALUES
    ('deezbot', 'ONLINE', '[1,2)'::int4range),
