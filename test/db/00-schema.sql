...
CREATE PUBLICATION deezbase_realtime FOR ALL TABLES;
...
ALTER TABLE public.users REPLICA IDENTITY FULL; -- Send "previous data" to deezbase
...
ALTER TABLE public.messages REPLICA IDENTITY FULL; -- Send "previous data" to deezbase
